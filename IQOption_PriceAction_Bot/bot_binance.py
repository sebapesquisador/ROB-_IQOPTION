...
class BinancePriceActionBot:
    ...
    def __init__(self):
        ...
        self.api_key = "oJpVRpAaH6TW6T8sf6Hur7Tj0wi8f6M101ACn5Qz0nmMIPEloh020Jll81cONZRh"  # ← COLOQUE SUA API KEY AQUI
        self.api_secret = "NkFYTKW8V5vXYq3BMWh0xrNi7qV4EmzknyvFBuBr7SGUjz2u1d6sVYoEQ8cfOE1T"  # ← COLOQUE SUA SECRET KEY AQUI
